...
function translateToUkrainian() {
    const translations = {
        ...
        project_title_sushi_bot_uk: "Телеграм-бот для суші",
        project_description_sushi_bot_uk: "Ласкаво просимо до Телеграм-бота для суші, вашого найкращого місця для замовлення смачних страв суші прямо з вашого додатка Telegram!",
        project_title_email_spammer_uk: "Email-Spammer",
        project_description_email_spammer_uk: "Email-Spammer - це скрипт на Python, який полегшує масове надсилання електронних листів кільком одержувачам з файлу Excel. Скрипт використовує бібліотеку PyQt для створення зручного інтерфейсу, де користувачі можуть ввести свої облікові дані електронної пошти, скласти повідомлення, вставити базу даних електронних адрес Excel та надіслати електронні листи.",
        project_title_traffic_arbitrage_uk: "Телеграм-бот для арбітражу трафіку",
        project_description_traffic_arbitrage_uk: "Телеграм-бот для арбітражу трафіку - це платформа, розроблена для полегшення купівлі та продажу трафіку між майстрами трафіку та адміністраторами каналів Telegram. Цей бот виступає як посередник, надаючи пропозиції (замовлення) та забезпечуючи комфортний робочий процес для обох сторін. Користувачі можуть отримувати виплати за залучення підписників до різних каналів Telegram.",
        project_title_stock_exchange_monitor_uk: "Телеграм-бот для моніторингу фондових бірж",
        project_description_stock_exchange_monitor_uk: "Бот збирає та моніторить дані про майбутні та найближчі проєкти з різних фондових бірж, надаючи своєчасні оновлення та детальну інформацію для інвесторів і аналітиків.",
        project_title_residential_complex_uk: "Телеграм-бот для житлового комплексу",
        project_description_residential_complex_uk: "Ласкаво просимо до TeleBot-Residential-Complex! Цей Телеграм-бот дозволяє мешканцям надсилати різні запити, пов'язані з контролем доступу та безпекою в межах житлового комплексу.",
